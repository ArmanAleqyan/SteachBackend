...
const FullUrl = 'http://80.78.246.59/Stech/public/';
...
$(document).ready(function () {
                    ...
                    if(response.data.data.file == null){
                        main_div.append(`<li class="chat-right">
                                            ...
                                            <div class="chat-avatar">
                                                <img src="http://80.78.246.59/Stech/storage/app/uploads/${response.data.data.photo}" alt="Retail Admin">
                        ...
                        let type = fileType[fileType.length-1]
                         ...
                         if(type == 'jpg' || type == 'png' || type == 'gif' || type == 'jpeg' || type == 'tif' || type == 'tiff'){
                             main_div.append(`<li class="chat-right">
                                            ...
                                            <a href="http://80.78.246.59/Stech/storage/app/uploads/${ response.data.data.file }" download><img src="http://80.78.246.59/Stech/storage/app/uploads/${ response.data.data.file }" style="height: 130px;
    width: 130px;"></img>  </a>                                            </div>
                             ...
                             main_div.append(`<li class="chat-right">
                                            <div class="chat-hour"> ${response.data.data.created_at}  </div>
                                            <div class="chat-text" style="background: none !important;  align-items: center !important;  display: flex;">
                                            <a href="http://80.78.246.59/Stech/storage/app/uploads/${ response.data.data.file }" download><img src="http://80.78.246.59/Stech/public/icons8-file-download-96.png" style="height: 130px;
    width: 130px;"></img>  </a>                                            </div>
                                            <div class="chat-avatar">
                                                <img src="http://80.78.246.59/Stech/storage/app/uploads/${response.data.data.photo}" alt="Retail Admin">
                                                <div class="chat-name">${response.data.data.name}</div>
...
$(document).ready(function () {
                            ...
                            if(value.message == null){
                                ...
                                if(type == 'jpg' || type == 'png' || type == 'gif' || type == 'jpeg' || type == 'tif' || type == 'tiff') {
                                    main_div.append(`<li class="chat-right">
                                            ...
                                            <div class="chat-text" style="background: none !important; align-items: center !important;  display: flex;" >
                                          <a href="http://80.78.246.59/Stech/storage/app/uploads/${value.file}" download><img style="    height: 130px;  width: 130px;" src="http://80.78.246.59/Stech/storage/app/uploads/${value.file}"></img>  </a>                                              </div>
                                            <div class="chat-avatar">
                                                <img src="http://80.78.246.59/Stech/storage/app/uploads/${value.sender_message.photo}" alt="Retail Admin">
                                    ...
                                    main_div.append(`<li class="chat-right">
                                            ...
                                            <div class="chat-text" style="background: none !important; align-items: center !important;  display: flex;" >
                                          <a href="http://80.78.246.59/Stech/storage/app/uploads/${value.file}" download><img style="    height: 130px;  width: 130px;" src="http://80.78.246.59/Stech/public/icons8-file-download-96.png"></img>  </a>                                              </div>
                                            <div class="chat-avatar">
                                                <img src="http://80.78.246.59/Stech/storage/app/uploads/${value.sender_message.photo}" alt="Retail Admin">
                                                <div class="chat-name">${value.sender_message.name}</div>
                                            </div>
 ...
 <a href="http://80.78.246.59/Stech/public/admin/OnePageGetNewCustomers/user_id=${value.sender_message.id}">
                                            <div class="chat-avatar">
                                                <img src="http://80.78.246.59/Stech/storage/app/uploads/${value.sender_message.photo}" alt="Retail Admin">
                                                <div class="chat-name">${value.sender_message.name}</div>
                                            </div>
                                            ...
                                            <div class="chat-text" style="background: none !important;  align-items: center !important;  display: flex;">
                                     <a href="http://80.78.246.59/Stech/storage/app/uploads/${value.file}" download=""><img src="http://80.78.246.59/Stech/storage/app/uploads/${value.file}" style="    height: 130px;  width: 130px;"></img></a>        
                                              </div>
                                            <div class="chat-hour">${value.time}  </div>
                                        </li>`)
                                }else{
 ...
 <a href="http://80.78.246.59/Stech/public/admin/OnePageGetNewCustomers/user_id=${value.sender_message.id}">
                                            ...
                                            <div class="chat-text" style="background: none !important;  align-items: center !important;  display: flex;">
                                     <a href="http://80.78.246.59/Stech/storage/app/uploads/${value.file}" download=""><img src="http://80.78.246.59/Stech/public/icons8-file-download-96.png" style="    height: 130px;  width: 130px;"></img></a>        
                                              </div>
                                            <div class="chat-hour">${value.time}  </div>
                                        </li>`)
                                }
...
channel.bind('pusher:subscription_succeeded', function(members) {
    channel.bind("App\\Events\\NewMessageEvent", function(data) {
        ...
        audioElement.setAttribute('src', 'http://80.78.246.59/Stech/public/iphone_notification.mp3');
        audioElement.play();
        ...
        if(data.message.sender_id == $("input[name='receiver_id']").val()){
            ...
            if(data.message.file == null){
                main_div.append(`<li class="chat-left">
                                         <a href="http://80.78.246.59/Stech/public/admin/OnePageGetNewCustomers/user_id=${data.message.sender_id}">
                                         <div class="chat-avatar">
                                                <img src="http://80.78.246.59/Stech/storage/app/uploads/${data.message.photo}" alt="Retail Admin">
                ...
                main_div.append(`<li class="chat-left">
                                <a href="http://80.78.246.59/Stech/public/admin/OnePageGetNewCustomers/user_id=${data.message.sender_id}">
                                            ...
                                            <div class="chat-text" style="background: none !important; align-items: center !important;  display: flex;">
                                          <a href="http://80.78.246.59/Stech/storage/app/uploads/${data.message.file}" download><img style="    height: 130px;
    width: 130px;" src="http://80.78.246.59/Stech/storage/app/uploads/${data.message.file}"></img> </a>   
                                              </div>
                                            <div class="chat-hour">${data.message.time}  </div>
                                        </li>`)
            }else{
                    main_div.append(`<li class="chat-left">
                                <a href="http://80.78.246.59/Stech/public/admin/OnePageGetNewCustomers/user_id=${data.message.sender_id}">
                                            ...
                                            <div class="chat-text" style="background: none !important; align-items: center !important;  display: flex;">
                                          <a href="http://80.78.246.59/Stech/storage/app/uploads/${data.message.file}" download><img style="    height: 130px;
    width: 130px;" src="http://80.78.246.59/Stech/public/icons8-file-download-96.png"></img> </a>   
                                              </div>
                                            <div class="chat-hour">${data.message.time}  </div>
                                        </li>`)
                }
                                    ...
                                    <ul  class="users room_id" data-id="${res.room_id}">
                                        <li  class="person" data-chat="person1" >
                                            <div  style="    display: flex;    align-items: center;    justify-content: space-between;">
                                                <div>
                                            <div  class="user">
                                                <img src="http://80.78.246.59/Stech/storage/app/uploads/${res.user_image}" alt="Retail Admin">
                                            </div>
                                            <p class="name-time">
