            ...
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{'searchExucator'}}" style="width: 80%; justify-content: flex-end;" class="nav-link mt-2 mt-md-0 d-none d-lg-flex search">
                            @csrf
                         <select name="Searchmethod" style="width: 15%;" class="form-control">
                            ...
                            <input style="width: 50%" required type="text" class="form-control" name="search" placeholder="Искать пользователя">
                        </form>
                        </div>
                        <br>
